					...
					<div className="content-card text-center group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
						<div className="space-y-4">
							...
							<a
								...
								className="inline-block text-xl md:text-2xl font-semibold text-purple-600 hover:text-purple-800 transition-colors duration-200 hover:scale-105 transform"
							>
					...
					<div className="content-card text-center group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
						<div className="space-y-4">
							...
							<a
								...
								className="inline-block text-xl md:text-2xl font-semibold text-green-600 hover:text-green-800 transition-colors duration-200 hover:scale-105 transform"
							>
